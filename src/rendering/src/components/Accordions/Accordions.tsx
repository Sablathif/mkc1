  ...
  return (
    <section className="accordion-wrapper section grey-section">
      <div className="container">
        <h2 className="title title-center"><Text field={props.fields.Title} /></h2>
        <div className="accordion accordion-background">
          {props.fields.AccordionCard.map((item, index) => (
            ...
            >
              ...
              {item.fields.IconClass.value == 'faHeart' ? <FontAwesomeIcon icon={faHeart} /> : <></>}
              {item.fields.IconClass.value == 'faStar' ? <FontAwesomeIcon icon={faStar} /> : <></>}
              {item.fields.IconClass.value == 'faCircle' ? <FontAwesomeIcon icon={faCircle} /> : <></>}
...
// const Accordions = () => {
//   return <AccordionCard items={props} />;
// };
