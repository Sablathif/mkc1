...
import { faHeart, faPlus, faMinus, faCircle, faStar, IconDefinition } from '@fortawesome/free-solid-svg-icons';
        ...
        {items.map((item, index) => (
          <div className={`accordion-item ${activeIndex === index ? 'expanded' : ''}`} key={index}>
            ...
            <FontAwesomeIcon icon={item.icon}/>
              ...
              {activeIndex === index && <div className="card-body"><p>{item.content}</p></div>}
