...
function Pagination(props) {
  const { totalPage = 1, distance = 2 } = props;
        ...
        <ul className="pagination">
          <li className={`page-item ${page < 2 ? 'disabled' : ''}`}>
            <ALink
              ...
              href={
                page > 1 ? { pathname: router.pathname, query: { ...query, page: page - 1 } } : '#'
              }
              scroll={false}
            >
                ...
                <li className={`page-item ${page === item ? 'active' : ''}`}>
                  <ALink
                    ...
                    href={
                      page === item
                        ? '#'
                        : { pathname: router.pathname, query: { ...query, page: item } }
                    }
                    scroll={false}
                  >
                    {item}
          ...
          <li className={`page-item ${page > totalPage - 1 ? 'disabled' : ''}`}>
            <ALink
              ...
              href={
                page < totalPage
                  ? { pathname: router.pathname, query: { ...query, page: page + 1 } }
                  : '#'
              }
              scroll={false}
            >
