...
const FrenchsHeader = (props: FrenchsHeaderProps): JSX.Element => {
  ...
  return (
    <section className="full-width w-100">
      <header className="" >
        <nav className="navbar navbar-expand-md navbar-light bg-light" style={{ backgroundImage: 'url("/-/media/Project/PLAY/playwebsite/media/img/icons/bg_header_frenchs.jpg?h=66&iar=0&w=1200&hash=539838FCEDD56C49AEAF209ABDAAC139")', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
          <div className="container-fluid">
            <a className="navbar-brand ml-5" href="/">
              <img src={logoSrc} alt="Logo" width="100" height="150" style={{ marginTop: '-60%' }} />
            </a>
            <button
