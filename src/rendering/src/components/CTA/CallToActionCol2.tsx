                            ...
                            <div className="col-md-6 mb-4" key={index}>
                                <div className="banner banner-1 banner-fixed content-center content-middle">
                                    ...
                                    <div className="banner-content">
                                        <h3 className="banner-title text-uppercase font-weight-bold ls-m text-primary">{data.fields.BannerTitle.value}</h3>
                                        <h4 className="banner-subtitle font-weight-bold ls-m text-white">{data.fields.BannerSubTitle.value}</h4>
                                        <p className="ls-s text-light">{data.fields.Description.value}</p>
                                        <ALink href={data.fields.CTALink.value} className="btn btn-outline btn-white btn-md btn-rounded">{data.fields.CTAText.value}</ALink>
                                    </div>
                                </div>
                            </div>
                                ): (
                                ...
                                <div className="banner banner-2 banner-fixed content-center content-middle">
                                    ...
                                    <div className="banner-content">
                                        <h3 className="banner-title text-uppercase font-weight-normal ls-m text-white mb-3">
                                            {data.fields.BannerTitle.value}</h3>
                                        ...
                                        <form action="#" method="get" className="input-wrapper">
                                            <input type="email" className="form-control w100 text-white text-center mb-4"
                                                ...
                                                required />
                                            <button className="btn btn-white btn-md btn-ellipse btn-rounded" type="submit">{data.fields.CTAText.value}<i
