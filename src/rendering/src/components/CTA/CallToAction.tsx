            ...
            <div className="banner cta-simple">
                <div className="banner-content bg-white d-lg-flex align-items-center">
                    <div className="banner-header pr-lg-7 pb-lg-0 pb-4 mb-lg-0 mb-6">
                        <h3 className="banner-title font-weight-bold ls-s text-uppercase">{props.fields.BannerTitle.value}</h3>
                        <h4 className="banner-subtitle font-weight-normal ls-s text-body">{props.fields.BannerSubTitle.value}</h4>
                    </div>
